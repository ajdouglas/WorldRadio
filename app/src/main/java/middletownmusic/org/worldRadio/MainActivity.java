package middletownmusic.org.worldRadio;
...
import middletownmusic.org.worldRadio.fragments.AboutFragment;
import middletownmusic.org.worldRadio.fragments.HelpFragment;
import middletownmusic.org.worldRadio.fragments.LoadingFragment;
import middletownmusic.org.worldRadio.fragments.RadioFragment;
import middletownmusic.org.worldRadio.fragments.StationInfoFragment;
import middletownmusic.org.worldRadio.fragments.StationListFragment;
import middletownmusic.org.worldRadio.models.Station;
import middletownmusic.org.worldRadio.utils.DrawerUtils;
    ...
    public void drawerItemClicked(DrawerUtils.DrawerItem item) {
        switch(item.title){
            ...
            case "Submit a Station":
                Intent browserIntentSubmit = new Intent(Intent.ACTION_VIEW, Uri.parse("http://willshare.com/cs495/WRP/frontend/#/submit"));
                startActivity(browserIntentSubmit);
                break;
            case "Report a Station":
                Intent browserIntentReport = new Intent(Intent.ACTION_VIEW, Uri.parse("http://willshare.com/cs495/WRP/frontend/#/report"));
